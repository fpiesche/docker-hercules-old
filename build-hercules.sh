...
rm /build/Hercules/conf/import
mv /build/Hercules/conf/* /build/distrib/conf/
...
chmod -R a+rwx /build/distrib
tar -zcf /build/hercules-`date +"%Y-%m-%d_%H-%M-%S"`.tar.gz /build/distrib
